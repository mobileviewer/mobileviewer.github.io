/**
 * Global variables & Component Loading
 */
    ...
    return fetch(file)
        ...
        .then(data => {
            ...
            if (element) {
                ...
                // Re-initialize any listeners that depend on the injected HTML
                if (id === 'footer-placeholder') initNewsletter();
            }
        })
...
function loadURL() {
  ...
  const iframe = currentDevice === "mobile" 
...
/**
 * Newsletter Initialization (for dynamically loaded footer)
 */
